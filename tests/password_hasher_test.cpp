...
int main() {
    try {
        ...
        const auto raw_result = chat::security::PasswordHasher::verifyCredential(
            password, encoded, "argon2id_raw");
        ...
        }
        {
            ...
            const bool upgraded = chat::security::ApplyPasswordUpgradeIfCurrent(
                ...
                [&current_hash, &current_scheme](const std::string& replacement,
                    ...
                    if (current_hash != expected_hash || current_scheme != expected_scheme) return 0;
        ...
        if (chat::security::PasswordHasher::verifyCredential(
                "wrong", legacy_argon, "legacy_client_sha256").valid
            || chat::security::PasswordHasher::verifyCredential(
                password, encoded, "unknown_scheme").valid) {
