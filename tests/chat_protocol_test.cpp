...
int main() {
    if (!IsClientRequestMessage(MSG_CHAT_LOGIN) || !IsClientRequestMessage(ID_TEXT_CHAT_MSG_REQ) ||
    ...
    if (IsClientRequestMessage(ID_TEXT_CHAT_MSG_RSP) ||
        ...
        IsClientRequestMessage(ID_HEARTBEAT_RSP) || IsClientRequestMessage(2048)) {
