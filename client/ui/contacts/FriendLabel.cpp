...
FriendLabel::FriendLabel(QWidget* parent) : QFrame(parent), ui(new Ui::FriendLabelClass()) {
    ui->setupUi(this);
    ui->close_lb->SetState("normal", "hover", "pressed", "selected_normal", "selected_hover",
                           "selected_pressed");
